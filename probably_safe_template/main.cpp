...
void initialise()
{
    ...
    std::vector<GLuint> witch_textures_ids = {
        load_texture("/Users/Sage/Downloads/Game Programming/exercise/exercise/assets/idle.png", NEAREST),   // IDLE spritesheet
        load_texture("/Users/Sage/Downloads/Game Programming/exercise/exercise/assets/attack.png", NEAREST)  // ATTACK spritesheet
    };
